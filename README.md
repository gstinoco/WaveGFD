...
The implemented methods are discussed in detail in the following publications:
  ...
  - [A meshless finite difference scheme applied to the numerical solution of wave equation in highly irregular space regions](https://doi.org/10.1016/j.camwa.2023.01.035)
  
  - [Study of the stability of a meshless generalized finite difference scheme applied to the wave equation](http://dx.doi.org/10.3389/fams.2023.1214022)
